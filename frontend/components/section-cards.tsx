...
//             20% de aumento de notas
//             <TrendingUpIcon className="size-4" />
//           </div>
//           <div className="text-muted-foreground">↑ 2% vs semestre passado</div>
//         </CardFooter>
//       </Card>
//       <Card className="@container/card">
//         <CardHeader>
...
//         <CardFooter className="flex-col items-start gap-1.5 text-sm">
//           <div className="line-clamp-1 flex gap-2 font-medium">
//             20% de alunos do Total{" "}
//             {/* <TrendingDownIcon className="size-4" /> */}
//           </div>
//           <div className="text-muted-foreground">
//             85% com notas e frequência acima 80%
//           </div>
//         </CardFooter>
//       </Card>
//       <Card className="@container/card">
...
//         <CardFooter className="flex-col items-start gap-1.5 text-sm">
//           <div className="line-clamp-1 flex gap-2 font-medium">
//             40% de alunos do Total
//             {/* <TrendingUpIcon className="size-4" /> */}
//           </div>
//           <div className="text-muted-foreground">
//             {" "}
//             150 alunos em potencial para risco baixo
//           </div>
//         </CardFooter>
//       </Card>
//       <Card className="@container/card">
...
//           <div className="text-muted-foreground">
//             {" "}
//             150 alunos com risco de evasão iminente
//           </div>
//         </CardFooter>
//       </Card>
//     </div>
